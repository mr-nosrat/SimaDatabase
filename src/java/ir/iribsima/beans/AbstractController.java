...
import ir.iribsima.dao.AbstractFacade;
import ir.iribsima.dao.LazyEntityDataModel;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    public Collection<T> getItemsTop() {
        if (items == null) {
            items = this.ejbFacade.findRange(new int[]{1, 100});
        }
        return items;
    }
